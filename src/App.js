...
function App() {
  return (
    <div className="App">
     ...
     <Text text='Create a custom protocol using the Anki Vector SDK that will allow a Vector Robot to programmatically solve a maze.' header='The Project'/>
